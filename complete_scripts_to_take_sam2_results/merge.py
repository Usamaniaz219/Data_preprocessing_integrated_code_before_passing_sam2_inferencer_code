...
if __name__ == "__main__":
    image = cv2.imread("/home/asfand/Work/sam2/testing/data/complete_test/wa_darrington/wa_darrington.jpg")
    cv2.namedWindow('image', cv2.WINDOW_NORMAL)
    cv2.resizeWindow('image',700,700)
    # mask_path = '/home/asfand/Work/sam2/testing/data/complete_test/wa_darrington/sam_results/wa_darrington_10'
    # merge_path = '/home/asfand/Work/sam2/testing/data/complete_test/wa_darrington/sam_merged/'
    image_dir_path = '/home/asfand/Work/sam2/testing/data/complete_test/wa_darrington'
    ...
    for sam_subdir in os.listdir(sam_path):
        ...
        # cv2.imwrite(merge_path + 'wa_darrington_10.jpg', result)
