...
if __name__ == "__main__":
    image = cv2.imread("/media/usama/SSD/Data_for_complete_sam2_scripts/Data_for_complete_sam2_scripts_29_april_2025/demo178_102/demo178_102.jpg")
    cv2.namedWindow('image', cv2.WINDOW_NORMAL)
    cv2.resizeWindow('image',700,700)
    # mask_path = '/home/asfand/Work/sam2/testing/data/complete_test/wa_darrington/sam_results/wa_darrington_10'
    merge_path = '/media/usama/SSD/Data_for_complete_sam2_scripts/Data_for_complete_sam2_scripts_29_april_2025/demo178_102/sam_merged/'
    image_dir_path = '/media/usama/SSD/Data_for_complete_sam2_scripts/Data_for_complete_sam2_scripts_29_april_2025/demo178_102/'
