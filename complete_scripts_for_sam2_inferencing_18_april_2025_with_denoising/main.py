...
from mean_shift_noise_removal import remove_noise_2
...
base_location = '/media/usama/SSD/Data_for_complete_sam2_scripts/Data_for_complete_sam2_scripts_29_april_2025_without_bluring/'
